...
$lang = array_merge($lang, [
	...
	'FILEMANAGER_NOT_WRITABLE'					=> 'Каталог конфигурации файлового менеджера (root/ResponsiveFilemanager/filemanager/config/) закрыт для записи. Измените права доступа (777 или -rwxrwxrwx при помощи FTP клиента)',
