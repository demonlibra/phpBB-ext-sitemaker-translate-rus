...
$strings = array(
	...
	'ADD_BULK_MENU_EXPLAIN'		=> 'Добавить несколько элементов меню одновременно.<br /> - Разместите каждый элемент на отдельной строке<br /> - Используйте клавишу <strong>Tab</strong> (табуляции) к отступу элементов для создания иерархии <br /> - Укажите элемент и URL адрес следующим образом: Home|index.php',
	...
	'ITEM_TITLE_EXPLAIN'		=> 'Установить как ’-’ для разделения',
